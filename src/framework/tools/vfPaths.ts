 ...
 */
export async function ensureIdeaWorkspace(repoRootAbs: string, ideaId: string): Promise<IdeaWorkspace> {
...
async function ensureFile(fileAbs: string, initial: string) {
  try {

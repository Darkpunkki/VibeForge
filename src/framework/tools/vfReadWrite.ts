...
function resolveKind(wsRootAbs: string, kind: string): string {
  ...
  const map: Record<string, string> = {
    ...
    'inputs.normalizer_config': 'inputs/normalizer_config.md',
    'inputs.concept_config': 'inputs/concept_config.md',
    'inputs.epic_config': 'inputs/epic_config.md',
    'inputs.feature_config': 'inputs/feature_config.md',
    'inputs.task_config': 'inputs/task_config.md',
    'inputs.validator_config': 'inputs/validator_config.md',
    'latest.idea_normalized': 'latest/idea_normalized.md',
    'latest.concept_summary': 'latest/concept_summary.md',
    'latest.codebase_context': 'latest/codebase_context.md',
    'latest.existing_solution_map': 'latest/existing_solution_map.md',

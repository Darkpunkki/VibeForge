...
export function registerEnsureIdeaWorkspace(server) {
    server.registerTool('vf.ensure_idea_workspace', {
        title: 'Ensure idea workspace',
        description: 'Ensures docs/forge/ideas/<IDEA_ID>/ exists with inputs/, latest/, runs/, and creates per-idea manifest.md and run_log.md if missing.',
        inputSchema: {

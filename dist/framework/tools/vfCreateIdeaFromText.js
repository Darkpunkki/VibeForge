...
async function nextIdeaNumber(repoRootAbs) {
...
export function registerCreateIdeaFromText(server) {
    server.registerTool('vf.create_idea_from_text', {
        title: 'Create idea folder from text',
        description: 'Allocates a new IDEA-XXXX-<slug> folder under docs/forge/ideas/, creates inputs/latest/runs, and initializes manifest.md + run_log.md.',
        inputSchema: {

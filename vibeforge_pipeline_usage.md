      ...
      ideas/
        <IDEA_ID>/
          ...
          latest/
            ...
            concept_summary.md
            epics.md
            PROJECT_ARCHITECTURE.md   (after scaffold-project)
            features.md
            tasks.md
            validators/
...
5. Scaffold project architecture (recommended)
- `/scaffold-project IDEA-0003_my-idea`
- Creates PROJECT_ARCHITECTURE.md with folder structure
- Optionally generates physical folders and skeleton files

6. Extract features
- `/feature-extractor IDEA-0003_my-idea`

7. Validate features (optional but recommended)
- `/validate-features IDEA-0003_my-idea`

8. Build tasks
- `/task-builder IDEA-0003_my-idea`

9. Validate tasks (optional but recommended)
...
4) `/scaffold-project <IDEA_ID>`
- Reads: `latest/idea_normalized.md` + `latest/concept_summary.md` + `latest/epics.md`
- Writes: `runs/<RUN_ID>/PROJECT_ARCHITECTURE.md` and updates `latest/PROJECT_ARCHITECTURE.md`
- Optionally creates physical folder structure and skeleton files
- Updates manifest + run log

5) `/feature-extractor <IDEA_ID>`
- Reads: `latest/concept_summary.md` + `latest/epics.md` + `latest/PROJECT_ARCHITECTURE.md` (if exists) + idea context
...
1) Write `inputs/idea.md` (or use `/imagine` to generate it interactively)
2) Run normalize + concept summary
3) Run epic extraction + validate epics
4) **Run scaffold-project to design architecture** (NEW!)
5) Run feature extraction + validate features
6) Run task builder + validate tasks
7) Queue 1–3 WPs using `/into-wps <IDEA_ID> [filters]`
8) Execute WPs using `/work-wp` (or `/work-wp WP-####`)
9) Iterate: enqueue more WPs, execute, repeat
...
1) Create idea interactively:
- `/imagine IDEA-0003_my-idea`
- Answer clarifying questions
- Review and finalize idea.md
...
- `/epic-extractor IDEA-0003_my-idea`
- `/validate-epics IDEA-0003_my-idea`
- `/scaffold-project IDEA-0003_my-idea` ← NEW! Creates architecture
- `/feature-extractor IDEA-0003_my-idea`
- `/validate-features IDEA-0003_my-idea`
- `/task-builder IDEA-0003_my-idea`
- `/validate-tasks IDEA-0003_my-idea`
